...
# Combien il y a t-il de journalistes dans l'array ?
print "Le nombre de journalistes est de : "
puts array.size
puts ""

# Combien d'handle contiennent un numéro ?
print "Nombre de handle avec numéro :"
puts array.count {|items| items.match(//)}
puts ""

# Combien d'handle contiennent les 4 lettres du prénom "Aude" à la suite (sans prendre en compte les majuscules) ?
print "Nombre de handle contenant le mot 'Aude' (minuscule comme majuscule) :"
puts array.count {|items| items.downcase.match(/aude/)}
puts ""

# Combien commencent par une majuscule (première lettre juste après le @) ?
print "Nombre de handle commençant par une majuscule après @ :"
puts array.count {|items| items.match(/@\p{Lu}/)}
puts ""


# Combien contienent une majuscule ?
print "Nombre de handle avec majuscule :"
puts array.count {|items| items.match(/[A-Z]/)}
puts ""

# Combien y a-t-il de underscore _ dans tous les pseudos confondus ?
print "Nombre de underscore dans le tableau :"
puts array.count {|items| items.match(/_/)}
puts ""

# Trie la liste de handle par ordre alphabétique.
puts "Handle en ordre alphabétique :"
puts array.sort_by {|items| items.downcase}
puts ""

# Quels sont les 50 handles les plus courts de ce array ?
puts "50handle les plus courts :"
puts array.sort_by {|items| items.length} [0..49]
puts ""

# Quelle est la position dans l'array de la personne @epenser ?
print "La personne @penser se trouve à la place :"
